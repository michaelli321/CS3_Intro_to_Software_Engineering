...
Scene* initialize_scene(void) {
    ...
    for (size_t i = 0; i <= num_of_circles; i++) {
        List* circle1 = get_circle_points(center_x, -center_y, CIRCLE_RADIUS, LENGTH_AND_HEIGHT);
        List* circle2 = get_circle_points(center_x, center_y, CIRCLE_RADIUS, LENGTH_AND_HEIGHT);
